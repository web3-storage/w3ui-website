        ...
        <>
            <div className="md:flex justify-between items-center gap-12">
                <div className={`ui-${id} card relative rounded-xl shadow-xl p-6 xl:p-8 max-w-xs md:max-w-md transition mb-6 md:mb-0`}>
                    <Image src={`/ui-${id}.svg`} alt="ui-auth" width="400" height="200" />
                </div>
            ...
            <p className="text-gray-400 my-16 text-left md:text-center"><strong className="text-white font-semibold">Supported frameworks:</strong> React</p>
        </>
    )
}