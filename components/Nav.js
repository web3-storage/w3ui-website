...
export const Nav = () => {
    return (
        <>
            ...
            <a href={`https://github.com/web3-storage/w3ui/blob/main/docs/`} target="_blank" rel="noreferrer" className="hover:text-gray-300 transition-all">API Reference</a>

            <a href={`https://github.com/web3-storage/w3ui`} target="_blank" rel="noreferrer" className="hover:text-gray-300 transition-all">
