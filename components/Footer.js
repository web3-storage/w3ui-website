        ...
        <footer className="flex justify-center py-8">
            <div className="mx-auto w-full max-w-6xl overflow-hidden py-12 px-10 md:px-20">
                ...
                <p className="mt-24 flex justify-center items-center space-x-6">
                    <a href="https://github.com/web3-storage/w3ui" target="_blank" rel="noreferrer" className="w-6 h-6">
                    ...
                    <a href="https://twitter.com/web3storage" target="_blank" rel="noreferrer" className="w-6 h-6">
                    ...
                    <a href="https://discord.com/channels/806902334369824788/864892166470893588" target="_blank" rel="noreferrer" className="w-6 h-6">
